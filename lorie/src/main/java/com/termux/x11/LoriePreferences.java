...
public class LoriePreferences extends AppCompatActivity implements PreferenceFragmentCompat.OnPreferenceStartFragmentCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.prefs_container, new LoriePreferenceFragment(null)).commit();
    ...
    protected void onResume() {
        ...
        if (SDK_INT >= Build.VERSION_CODES.O)
            registerReceiver(receiver, filter, SDK_INT >= Build.VERSION_CODES.TIRAMISU ? Context.RECEIVER_NOT_EXPORTED : 0);
        else
