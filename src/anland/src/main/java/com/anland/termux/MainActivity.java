...
public class MainActivity extends Activity
    ...
    private static final String DEFAULT_SOCKET_PATH = "/data/data/com.xiaoian.app/files/tmp/anland/display_daemon.sock";
    ...
    private void registerCompatibleReceiver() {
        if (!false || compatibleReceiverRegistered)
            return;
    ...
    private void attachCompatibleFd() {
        if (!false || compatibleBridge == null || compatibleFdReady)
            return;
